...
if five_letter_word[0] == single_char: 
    print(single_char + " was found at index 0.")
    matches = matches + 1
if five_letter_word[1] == single_char:
    print(single_char + " was found at index 1.")
    matches = matches + 1
if five_letter_word[2] == single_char:
    print(single_char + " was found at index 2.")
    matches = matches + 1
if five_letter_word[3] == single_char:
    print(single_char + " was found at index 3.")
    matches = matches + 1
if five_letter_word[4] == single_char:
    print(single_char + " was found at index 4.")
    matches = matches + 1
